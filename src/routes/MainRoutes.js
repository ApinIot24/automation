...
const TableDefaultSix1 = Loadable(lazy(() => import('views/dashboard/Default/BB/OptionTablePL6')));
...
const TableLhpL6 = Loadable(lazy(() => import('views/dashboard/Default/BB/TableLhpL6')));
...
const TableAllsix1 = Loadable(lazy(() => import('views/dashboard/Default/BB/TablePackingL6')));
const TableWeeklysix1 = Loadable(lazy(() => import('views/dashboard/Default/BB/TableWeeklyPL6')));
const TableDailysix1 = Loadable(lazy(() => import('views/dashboard/Default/BB/TableDailyPL6')));
const TableHourlysix1 = Loadable(lazy(() => import('views/dashboard/Default/BB/TableHourlyPL6')));
const TableMonthlysix1 = Loadable(lazy(() => import('views/dashboard/Default/BB/TableMonthlyPL6')));
// utilities routing
...
const Packingl6 = Loadable(lazy(() => import('views/utilities/Packingl6')));
...
const WaferLine6 = Loadable(lazy(() => import('views/pages/LHP/Wafer/wafer_line6/WaferLine6')));
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        {
          path: 'packing-line6',
          element: <PrivateRoute element={<Packingl6 />} />
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        {
          path: 'packing-line6/table/all',
          element: <PrivateRoute element={<TableAllsix1 />} />
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        {
          path: 'packing-line6/table/lhp',
          element: <PrivateRoute element={<TableLhpL6 />} />
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        {
          path: 'packing-line6/table',
          element: <PrivateRoute element={<TableDefaultSix1 />} />
        }
      ]
    },
    {
      ...
      children: [
        {
          path: 'packing-line6/table/hourly',
          element: <PrivateRoute element={<TableHourlysix1 />} />
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        {
          path: 'packing-line6/table/daily',
          element: <PrivateRoute element={<TableDailysix1 />} />
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        {
          path: 'packing-line6/table/weekly',
          element: <PrivateRoute element={<TableWeeklysix1 />} />
        }
      ]
    },
    {
      ...
      children: [
        {
          ...
          element: <PrivateRoute element={<TableMonthlysix1 />} />
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        {
          path: 'lhp-line6',
          element: <PrivateRoute element={<WaferLine6 />} />
        }
      ]
    },
    {
