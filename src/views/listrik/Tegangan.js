...
const Tegangan = ({ isLoading,url,label }) => {
  ...
  axios.get(newValue + label + 'R' )
    .then(response => {
      ...
      if(datalasts.length===0){
        ...
        for (let index = 0; index < datalasts.length; index++) {
          counts.push(datalasts[index].tegangan)
        }
        setL1(counts);
      }
    })
    ...
    .then(response => {
      ...
      if(datalasts.length===0){
        ...
        for (let index = 0; index < datalasts.length; index++) {
          countss.push(datalasts[index].tegangan)
        }
        setL2(countss);
      }
    })
    ...
    .then(response => {
      ...
      if(datalasts.length===0){
        ...
        for (let index = 0; index < datalasts.length; index++) {
          countsss.push(datalasts[index].tegangan)
        }
        setL3(countsss);
      }
    })
    ...
    .then(response => {
      ...
      if(datalasts.length===0){
        ...
        for (let index = 0; index < datalasts.length; index++) {
          countssss.push(datalasts[index].tegangan)
        }
        setAvg(countssss);
      }
    })
      ...
      axios.get(dinamisurl)
        .then(response => {
          ...
          for (let index = 0; index < datalast.length; index++) {
            count.push(datalast[index].tegangan)
          }
          setTegangan(count);
        })
        .catch(error => {
                        ...
                        <Grid item> 
                            <LineChart
                                ...
                                series={[
                                  {
                                    id: '1',
                                    label: 'Tegangan L1(Kw)',
                                    curve: "linear",
                                    data: l1,
                                  },
                                  {
                                    id: '2',
                                    label: 'Tegangan L2(Kw)',
                                    curve: "linear",
                                    data: l2,
                                  },
                                  {
                                    id: '3',
                                    label: 'Tegangan L3(Kw)',
                                    curve: "linear",
                                    data: l3,
                                  },
                                  {
                                    id: '4',
                                    label: 'Tegangan Avg(Kw)',
                                    curve: "linear",
                                    data: avg,
                                  },
                                ]}
