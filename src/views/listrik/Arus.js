...
const Arus = ({ isLoading ,url,label}) => {
    ...
    axios.get(newValue + label + 'R' )
      .then(response => {
        ...
        if(datalasts.length===0){
          ...
          for (let index = 0; index < datalasts.length; index++) {
            counts.push(datalasts[index].arus)
          }
          setL1(counts);
        }
      })
      ...
      .then(response => {
        ...
        if(datalasts.length===0){
          ...
          for (let index = 0; index < datalasts.length; index++) {
            countss.push(datalasts[index].arus)
          }
          setL2(countss);
        }
      })
      ...
      .then(response => {
        ...
        if(datalasts.length===0){
          ...
          for (let index = 0; index < datalasts.length; index++) {
            countsss.push(datalasts[index].arus)
          }
          setL3(countsss);
        }
      })
      ...
      .then(response => {
        ...
        if(datalasts.length===0){
          ...
          for (let index = 0; index < datalasts.length; index++) {
            countssss.push(datalasts[index].arus)
          }
          setAvg(countssss);
        }
      })
      ...
      axios.get(dinamisurl)
        .then(response => {
          ...
          for (let index = 0; index < datalast.length; index++) {
            count.push(datalast[index].arus)
          }
          setArus(count);
        })
        .catch(error => {
