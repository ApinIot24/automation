...
const TablePackingL2 = () => {
  const [value, setValue] = React.useState('packing_l2_daily');
  ...
  const [urlapi] = useState({
    ...
    packingl2_daily : 'http://10.37.12.17:3000/packing_l2_daily',
    urlp2 : 'table',
  ...
  const handleChange = (event, newValue) => {
    ...
    if(newValue=='packing_l2_daily'){
      axios.get(urlapi.packingl2)
      .then(response => {
        ...
        if (jamnih < 150 ) {
          ...
          axios.get(urlapi.packingl2_daily)
            .then(response => {
  ...
  <MainCard title="Packing Wafer Line 2" secondary={<ButtonBack path={'/utils/packing-line2/table'} />} >
    <TabContext value={value}>
          ...
          <Grid item xs={12} sm={10}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <TabList onChange={handleChange} aria-label="lab API tabs example">
                <Tab label="Home" value="packing_l2_daily" />
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DatePicker
                ...
                onChange={(newValue) => {
                  ...
                  if (value==='packing_l2_daily') {
                    axios.get(`http://10.37.12.17:3000/packing_l2_daily/date/${datestring}`)
                    .then(response => {
                      var dataolah = response.data;
      ...
      <TabPanel value="packing_l2_daily">
