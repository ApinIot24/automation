...
const TableWeeklyPL2 = () => {
  const [value, setValue] = React.useState('packing_l2_weekly');
  ...
  const [urlapi] = useState({
    ...
    packing_l2_weekly : 'http://10.37.12.17:3000/packing_l2_weekly',
    urlp2 : 'table',
  ...
  const handleChange = (event, newValue) => {
    ...
    if(newValue=='packing_l2_weekly'){
        axios.get(urlapi.packing_l2_weekly)
          .then(response => {
  ...
  <MainCard title="Packing Wafer Line 2" secondary={<ButtonBack path={'/utils/packing-line2/table'} />} >
    <TabContext value={value}>
        ...
        <Grid item xs={12} sm={10}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            <TabList onChange={handleChange} aria-label="lab API tabs example">
                <Tab label="Home" value="packing_l2_weekly" />
                ...
                <div>
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      let objects = [];  
                      let day = ['Monday','Tuesday','Wednesday','Thursday' , 'Friday' , 'Saturday','Total'];
                      if (value==='packing_l2_weekly') {
                        axios.get(`http://10.37.12.17:3000/packing_l2_weekly/date/${weekly}`)
                        .then(response => {
                        var dataolah  = response.data;
                        var datanih1  =   dataolah[0] === undefined ? 0 : dataolah[0].cntr_bandet 
                        var datanih2  =   dataolah[1] === undefined ? 0 : dataolah[1].cntr_bandet
      ...
      <TabPanel value="packing_l2_weekly">
