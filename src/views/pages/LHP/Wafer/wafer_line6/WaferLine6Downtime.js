...
const WaferLine6Downtime = () => {
  ...
  useEffect(() => {
    ...
    fetchData(`http://10.37.12.17:3000/downtime_daily/range/${formattedStartDate}/${formattedEndDate}/6`);
  }, [startDate, endDate]);
  ...
  return (
    <MainCard title="Report LHP Line 6"  >
...
export default WaferLine6Downtime;
