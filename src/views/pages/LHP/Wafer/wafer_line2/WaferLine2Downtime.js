...
const WaferLine2Downtime = () => {
  ...
  useEffect(() => {
    ...
    fetchData(`http://10.37.12.17:3000/downtime_daily/range/${formattedStartDate}/${formattedEndDate}/2`);
  }, [startDate, endDate]);
  ...
  return (
    <MainCard title="Report LHP Line 2"  >
...
export default WaferLine2Downtime;
