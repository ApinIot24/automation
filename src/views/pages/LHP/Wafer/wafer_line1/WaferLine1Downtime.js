...
const WaferLine1Downtime = () => {
  ...
  useEffect(() => {
    ...
    fetchData(`http://10.37.12.17:3000/downtime_daily/range/${formattedStartDate}/${formattedEndDate}/1`);
  }, [startDate, endDate]);
  ...
  return (
    <MainCard title="Report LHP Line 1"  >
...
export default WaferLine1Downtime;
