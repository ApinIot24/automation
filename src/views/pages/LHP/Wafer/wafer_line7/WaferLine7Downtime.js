...
const WaferLine7Downtime = () => {
  ...
  useEffect(() => {
    ...
    fetchData(`http://10.37.12.17:3000/downtime_daily/range/${formattedStartDate}/${formattedEndDate}/7`);
  }, [startDate, endDate]);
  ...
  return (
    <MainCard title="Report LHP Line 7"  >
...
export default WaferLine7Downtime;
