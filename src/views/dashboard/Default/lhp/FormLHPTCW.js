...
const FormLHPTCW = ({ isLoading ,pathnih,label0, label1 , label2 , label3, label4, label5  ,label6,label7,label8}) => {
          ...
          <CardContent>
                ...
                <Grid container spacing={2} direction="row" sx={{ mt: 1, width: '100%' }} >
                    ...
                    <Grid item xs={12} sm={5}>
                        ...
                        >
                            ...
                            <MenuItem value={'Wafello Chocoblast 12 x 10 x 17'}>Superstar TCW 8 X 20 X 16 </MenuItem>
                        </Select>
                        </FormControl>
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={2} direction="row" >
                    ...
                    <Grid item xs={12} sm={2.4}>
                        <FormControl required sx={{ m: 1, width: '100%' }}>
                        <TextField
                        onChange={e => setPlastikPof(e.target.value)}
                        value={plastikpof}
                            required
                            id="outlined-required"
