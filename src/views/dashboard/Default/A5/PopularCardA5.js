...
import BajajAreaChartCardA5 from './BajajAreaChartCardA5';
// ==============================|| HAPPY CODING ||============================== //

const PopularCardA5 = ({ isLoading ,url }) => {
          ...
          <CardContent>
            <Grid container spacing={gridSpacing}>
              ...
              <Grid item xs={12} sx={{ pt: '16px !important' }}>
                <BajajAreaChartCardA5 isurl={url}/>
              </Grid>
              <Grid item xs={12}>
...
PopularCardA5.propTypes = {
  isLoading: PropTypes.bool,
  url : PropTypes.bool
};

export default PopularCardA5;