...
const TableLhpL1 = ({ label1, label2, label3, label4, label5 }) => {
  ...
  return (
    <MainCard title="Report LHP Line 7" secondary={<ButtonBack path={'/utils/packing-line2/table'} />} >
          ...
          <CardWrapper>
            ...
            <Box sx={{ width: '100%' }}>
              <ChartContainer
                ...
                series={[
                  { id: '1', label: 'G1', type: 'line', curve: 'linear', data: chartData.pack1, color: '#FF5722', lineStyle: { strokeWidth: 3 } },
                  { id: '2', label: 'G2', type: 'line', curve: 'linear', data: chartData.pack2, color: '#2196F3', lineStyle: { strokeWidth: 3 } },
                  { id: '3', label: 'G3', type: 'line', curve: 'linear', data: chartData.pack3, color: '#8BC34A', lineStyle: { strokeWidth: 3 } },
                  { id: '4', label: 'G4', type: 'line', curve: 'linear', data: chartData.pack4, color: '#FFEB3B', lineStyle: { strokeWidth: 3 } },
                  { id: '5', label: 'G5', type: 'line', curve: 'linear', data: chartData.pack5, color: '#E91E63', lineStyle: { strokeWidth: 3 } },
                  { id: '6', label: 'G6', type: 'line', curve: 'linear', data: chartData.pack6, color: '#673AB7', lineStyle: { strokeWidth: 3 } },
                  { id: '7', label: 'G7', type: 'line', curve: 'linear', data: chartData.pack7, color: '#00BCD4', lineStyle: { strokeWidth: 3 } },
                  { id: '8', label: 'G8', type: 'line', curve: 'linear', data: chartData.pack8, color: '#FF9800', lineStyle: { strokeWidth: 3 } },
                  { id: '9', label: 'MAX', type: 'line', curve: 'linear', data: [0.8, 0.8, 0.8], color: '#f20707', lineStyle: { strokeWidth: 3 } }
                ]}
