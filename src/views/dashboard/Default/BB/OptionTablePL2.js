...
const OptionTablePL2 = () => {
  useEffect(() => {
    
  }, []);
  return (
  <MainCard title="Packing Wafer Line 2" secondary={<ButtonBack path={'/utils/packing-line2'} />}>
      <Grid container spacing={gridSpacing}>
        <Grid item xs={12}>
          <Grid container spacing={gridSpacing}>
            <Grid item lg={2.4} md={6} sm={6} xs={6}>
              <Box sx={{ minWidth: 275 }}>
              <Link to="/utils/packing-line2/table/all">
            ...
            <Grid item lg={2.4} md={6} sm={6} xs={6}>
              <Box sx={{ minWidth: 275 }}>
              <Link to="/utils/packing-line2/table/hourly">
                <CardWrapper border={false} content={false}>
                  <Box sx={{ p: 2.25 }}>
                    <Grid container direction="column">
                      <Grid item>
            ...
            <Grid item lg={2.4} md={6} sm={6} xs={6}>
              <Box sx={{ minWidth: 275 }}>
                <Link to="/utils/packing-line2/table/daily">
                <CardWrapper border={false} content={false}>
                  <Box sx={{ p: 2.25 }}>
                    <Grid container direction="column">
                      <Grid item>
            ...
            <Grid item lg={2.4} md={6} sm={6} xs={6}>
              <Box sx={{ minWidth: 275 }}>
                <Link to="/utils/packing-line2/table/weekly">
                <CardWrapper border={false} content={false}>
                  <Box sx={{ p: 2.25 }}>
                    <Grid container direction="column">
                      <Grid item>
            ...
            <Grid item lg={2.4} md={6} sm={6} xs={6}>
              <Box sx={{ minWidth: 275 }}>
                <Link to="/utils/packing-line2/table/monthly">
                <CardWrapper border={false} content={false}>
                  <Box sx={{ p: 2.25 }}>
                    <Grid container direction="column">
                      <Grid item>
        ...
        <Grid item xs={12}>
          <Grid container spacing={gridSpacing}>
            <Grid item lg={2.4} md={6} sm={6} xs={6}>
              <Box sx={{ minWidth: 275 }}>
              <Link to="/utils/packing-line2/table/lhp">
                <CardWrapper border={false} content={false}>
                  <Box sx={{ p: 2.25 }}>
                    <Grid container direction="column">
                      <Grid item>
