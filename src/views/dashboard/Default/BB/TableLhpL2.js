...
const TableLhpL1 = ({ label1, label2, label3, label4, label5 }) => {
  ...
  return (
    <MainCard title="Report LHP Line 2" secondary={<ButtonBack path={'/utils/packing-line2/table'} />} >
          ...
          <CardWrapper>
            ...
            <Box sx={{ width: '100%' }}>
              <ChartContainer
                ...
                height={300}
                series={[
                  { id: '1', label: 'B1', type: 'line', curve: 'linear', data: chartData.pack1, color: '#FF5722' },
                  { id: '2', label: 'B2', type: 'line', curve: 'linear', data: chartData.pack2, color: '#1017e3' },
                  { id: '3', label: 'B3', type: 'line', curve: 'linear', data: chartData.pack3, color: '#03ffbc' },
                  { id: '4', label: 'B4', type: 'line', curve: 'linear', data: chartData.pack4, color: '#ff0389' },
                  { id: '5', label: 'A4', type: 'line', curve: 'linear', data: chartData.pack5, color: '#9603ff' },
                  { id: '6', label: 'MAX', type: 'line', curve: 'linear', data: [0.8, 0.8, 0.8], color: '#f20707', lineStyle: { strokeWidth: 3 } }
                  //{ id: '6', label: 'Total', type: 'line', curve: 'linear', data: chartData.sumpack, color: '#ffb303' }
                ]}
            ...
            <Box sx={{ width: '100%' }}>
              <ChartContainer
                ...
                series={[
                  ...
                  { id: '2', label: 'MAX', type: 'line', curve: 'linear', data: [6.0, 6.0, 6.0], color: '#f20707' }
                ]}
                xAxis={[{ scaleType: 'point', data: ['Shift 1', 'Shift 2', 'Shift 3'] }]}
              >
                <LinePlot />
            ...
            <Box sx={{ width: '100%' }}>
              <ChartContainer
                ...
                series={[
                  ...
                  { id: '2', label: 'MAX', type: 'line', curve: 'linear', data: [13.7, 13.7, 13.7], color: '#f20707' }
                ]}
                xAxis={[{ scaleType: 'point', data: ['Shift 1', 'Shift 2', 'Shift 3'] }]}
              >
                <LinePlot />
