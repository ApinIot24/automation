...
const TablePackingL7 = () => {
  const [value, setValue] = React.useState('packing_l7_daily');
  ...
  const [urlapi] = useState({
    ...
    packingl7_daily : 'http://10.37.12.17:3000/packing_l7_daily',
    urlp2 : 'table',
  ...
  const handleChange = (event, newValue) => {
    ...
    if(newValue=='packing_l7_daily'){
      axios.get(urlapi.packingl7)
      .then(response => {
        ...
        if (jamnih < 150 ) {
          ...
          axios.get(urlapi.packingl7_daily)
            .then(response => {
  ...
  <MainCard title="Packing Wafer Line 7" secondary={<ButtonBack path={'/utils/packing-Line7/table'} />} >
    <TabContext value={value}>
          ...
          <Grid item xs={12} sm={10}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <TabList onChange={handleChange} aria-label="lab API tabs example">
                <Tab label="Home" value="packing_l7_daily" />
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DatePicker
                ...
                onChange={(newValue) => {
                  ...
                  if (value==='packing_l7_daily') {
                    axios.get(`http://10.37.12.17:3000/packing_l7_daily/date/${datestring}`)
                    .then(response => {
                      var dataolah = response.data;
      ...
      <TabPanel value="packing_l7_daily">
