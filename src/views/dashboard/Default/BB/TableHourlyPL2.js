...
const TablePackingL2 = () => {
  ...
  const [value, setValue] = React.useState('packing_l2_hourly');
  ...
  return (
    <MainCard title="Packing Wafer Line 2" secondary={<ButtonBack path={'/utils/packing-line2/table'} />}>
      <TabContext value={value}>
          ...
          <Grid item xs={12} sm={10}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <TabList onChange={handleChange} aria-label="lab API tabs example">
                <Tab label="Home" value="packing_l2_hourly" />
              ...
              <DatePicker
                ...
                onChange={(newValue) => {
                  ...
                  let hour = ['07:00 - 08:00', '08:00 - 09:00', '09:00 - 10:00', '10:00 - 11:00', '11:00 - 12:00',
                    '12:00 - 13:00', '13:00 - 14:00', '14:00 - 15:00', '15:00 - 16:00', '16:00 - 17:00', '17:00 - 18:00', '18:00 - 19:00', '19:00 - 20:00', '20:00 - 21:00',
                    '21:00 - 22:00', '22:00 - 23:00', '23:00 - 24:00', '24:00 - 01:00', '01:00 - 02:00', '02:00 - 03:00', '03:00 - 04:00', '04:00 - 05:00', '05:00 - 06:00', '06:00 - 07:00'];
                  if (value === 'packing_l2_hourly') {
                    axios.get(`http://10.37.12.17:3000/packing_l2_hourly/date/${formattedDate}`)
                      .then(response => {
                        var dataolah = response.data;
                        let objects = [];
                        for (let i = 0; i < dataolah.length; i++) {
        ...
        <TabPanel value="packing_l2_hourly">
